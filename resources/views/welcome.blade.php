            ...
            <div
                ...
                <div class="flex justify-start lg:w-0 lg:flex-1">
                    <a href={{ route('welcome') }}>
                        <span class="sr-only">The Domains I Own</span>
                            ...
                            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                                    ...
                                    <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        <div
                                            class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-white sm:h-12 sm:w-12">
                                            <x-heroicon-o-chat-alt-2 class="h-6 w-6"/>
                                        </div>
                                        <div class="ml-4">
                                            <p class="text-base font-medium text-gray-900">
                                                Live Chat
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                    <div class="absolute inset-0">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-purple-800 to-indigo-700 mix-blend-multiply"></div>
                    </div>
        ...
        <div class="relative pt-16 pb-32 overflow-hidden">
            ...
            <div class="relative">
                ...
                <span
                    ...
                    <x-heroicon-o-inbox class="h-6 w-6 text-white"/>
                </span>
                            </div>
                            <div class="mt-6">
                                ...
                                <div class="mt-6">
                                    <a href="#"
                                       class="inline-flex px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700">
                                        Get started
                                    </a>
                                </div>
                            </div>
              ...
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-white bg-opacity-10">
                  <x-heroicon-o-trash class="h-6 w-6 text-white"/>
                    ...
                    <div>
                        <div>
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-white bg-opacity-10">
                  <x-heroicon-o-pencil-alt class="h-6 w-6 text-white"/>
              </span>
                        </div>
                        <div class="mt-6">
                    ...
                    <div>
                        <div>
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-white bg-opacity-10">
                  <x-heroicon-o-document-report class="h-6 w-6 text-white"/>
              </span>
                        </div>
                        <div class="mt-6">
                    ...
                    <div>
                        <div>
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-white bg-opacity-10">
                  <x-heroicon-o-reply class="h-6 w-6 text-white"/>
              </span>
                        </div>
                        <div class="mt-6">
        ...
        <div class="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
                ...
                <div class="mt-12 xl:mt-0">
                    ...
                    <form class="mt-4 sm:flex sm:max-w-md">
                        ...
                        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                            <button type="submit"
                                    class="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700">
                                Subscribe
                            </button>
                        </div>
                    </form>
            ...
            <div class="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
                ...
                <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                    &copy; 2020 Gerenuk Ltd. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
